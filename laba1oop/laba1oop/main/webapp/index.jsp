...
<head>
    ...
    <title>MemeStore - Лучший магазин цветов города</title>
    <link
...
<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">MEMESTORE</a>
    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img src="rose.jpg" class="img-fluid" alt="1 carousel image">
                <div class="container">
                    <div class="carousel-caption text-start">
                        <h1>Розы</h1>
                        <p>Розы разных цветов</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <svg class="bd-placeholder-img" width="100%" height="100%"
                     ...
                     preserveAspectRatio="xMidYMid slice" focusable="false">
                    <rect width="100%" height="100%" fill="#777"></rect></svg>
                <img src="tul.jpg" class="img-fluid" alt="2 carousel image">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Тюльпаны</h1>
                        <p>Тюльпаны разных цветов</p>
                    </div>
                </div>
            </div>
            <div class="carousel-item">
                <svg class="bd-placeholder-img" width="100%" height="100%"
                     ...
                     preserveAspectRatio="xMidYMid slice" focusable="false">
                    <rect width="100%" height="100%" fill="#777"></rect></svg>
                <img src="giga.jpg" class="img-fluid" alt="3 carousel image">
                <div class="container">
                    <div class="carousel-caption text-end">
                        <h1>Другие</h1>
                        <p>И другие виды цветов</p>
                    </div>
                </div>
            </div>
        </div>
