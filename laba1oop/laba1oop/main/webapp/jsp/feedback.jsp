...
<form class="shadow p-5 mt-5 w-50 h-50 mx-auto rounded-bottom">
    <div class="shadow p-5 mt-5 w-50 h-50 mx-auto rounded-bottom">
        ...
        Свяжитесь с нами и получите персональное предложение по любому интересующему вас вопросу -
        от выступлений и мастер-классов по сборке головоломок до развития вашего бизнеса и оптовых поставок!
    </div>
    <div class="shadow p-5 mt-5 w-50 h-50 mx-auto rounded-bottom">
        <h4>Оптовые поставки</h4>
        Наша компания может предложить оптовые поставки как для бюджетных учреждений,
        так и для последующей реализации магазинам. Мы всегда рады новым партнерам!
    </div><br>
