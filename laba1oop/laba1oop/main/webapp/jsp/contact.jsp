...
<form class="shadow p-5 mt-5 w-50 h-50 mx-auto rounded-bottom">
    <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" value="order@memestore.ru" readonly>
    </div>
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">По вопросам оптовых закупок</span>
        <input type="text" class="form-control" value="supply@memestore.ru" readonly>
    </div>
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Для организаторов мероприятий</span>
        <input type="text" class="form-control" value="event@memestore.ru" readonly>
    </div>
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Адрес</span>
        <input type="text" class="form-control" value="Якутск, улица Длинная, 15" readonly>
    </div>
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Бесплатный звонок по всей России</span>
        <input type="text" class="form-control" value="8-800-555-35-35" readonly>
    </div>
</form>
</body>
</html>